                    ...
                    Column {
                        WindowDraggableArea(
                            ...
                            TopAppBar(
                                ...
                                when (hostOs) {
                                    OS.Linux -> LinuxTopBar(state, onCloseRequest)
                                    OS.Windows -> WindowsTopBar(state, onCloseRequest)
                                    OS.MacOS -> MacOsTopBar(state, onCloseRequest)
                                    else -> {}
                                }
                            }
                        }
...
@Composable
fun ApplicationScope.LinuxTopBar(state: WindowState, onExit: () -> Unit) {
...
@Composable
fun ApplicationScope.WindowsTopBar(state: WindowState, onExit: () -> Unit) {
    Box(modifier = Modifier.fillMaxSize()) {
        Row(
            modifier = Modifier.align(Alignment.CenterEnd),
            horizontalArrangement = Arrangement.Start
...
@Composable
fun ApplicationScope.MacOsTopBar(state: WindowState, onExit: () -> Unit) {
    Box(modifier = Modifier.fillMaxSize()) {
        Row(
            modifier = Modifier.align(Alignment.CenterStart),
            horizontalArrangement = Arrangement.Start
